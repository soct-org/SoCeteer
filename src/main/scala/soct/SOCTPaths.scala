...
object SOCTNames {
  ...
  val SOCT_SIMULATOR_EXE = s"simulator${if (SOCTUtils.isWindows) ".exe" else ""}" // Name of the simulator executable generated by the sim target in CMake, with .exe extension on Windows
