...
import soct.system.vivado.components.{AXIBdXInterface, ClockDomain, DDR4, DDR4BdIntfPort, DiffClockBdIntfPort, InlineConstant, InstantiableBdComp, IsModule, JTAGBdXInterface, SDCardPMOD, SDIOCDPort, SDIOClkPort, SDIOCmdPort, SDIODataPort}
