package soct.vivado.fpga

import org.chipsalliance.cde.config.Parameters
import soct.SOCTBytes._
import soct.vivado.abstracts.{BdIntfPort, PortCreation, PortMode}
...
trait DDR4PortParams extends IsMasterIf {
   ...
   * @throws soct.vivado.VivadoDesignException if no capacity has been set (see [[withCap]])
   */
  def getCap: Bytes = {
   ...
   *
   * @return this port, for chaining
   * @throws soct.vivado.VivadoDesignException if the board definition lacks the
   ...
   * module widens cs_n/cke/odt/ck) - see [[soct.vivado.abstracts.PortCreation.Externalize]].
   */
