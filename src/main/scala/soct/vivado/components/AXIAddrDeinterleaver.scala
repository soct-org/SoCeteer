...
case class AXIAddrDeinterleaver(mAxi: AXI4BusInfo, geometry: AXIAddrDeinterleaver.InterleaveGeometry)
   ...
   * design sources.
   *
   * @throws soct.vivado.VivadoDesignException if the bundled Verilog resource is missing
   */
...
object AXIAddrDeinterleaver {
   ...
   * @throws soct.vivado.VivadoDesignException if ExtMem is not defined in the parameters,
