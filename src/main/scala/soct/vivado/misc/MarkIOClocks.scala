...
import soct.vivado.abstracts.{BdChiselPin, BdIntfPin, BdPinBase, MapsToPorts}
...
case class MarkIOClocks(io: Map[ClockBundle, ClkDesc], resetGroup: String = "RESET", clockGroup: String = "CLOCK")
  ...
  /**
   * @throws soct.vivado.VivadoDesignException if a clock domain has associated AXI4
