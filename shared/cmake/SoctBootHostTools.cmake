...
macro(soct_boot_find_host_tools)
    ...
    if (CMAKE_HOST_APPLE)
        set(_khostflags "HOSTCFLAGS=-I${SOCETEER_ROOT}/binaries/boot/host-compat -include ${SOCETEER_ROOT}/binaries/boot/host-compat/darwin-compat.h -D_UUID_T -D__GETHOSTUUID_H")
